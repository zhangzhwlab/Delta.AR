...
function saveTarget(acstart,acend,vstart,vend,storageFile){
	...
	window.location.href="/deltaar/pipeline/saveAnchroTarget.action?anchorStart="+acstart+"&anchorEnd="+acend+"&viewStart="+vstart+"&viewEnd="+vend+"&storageFile="+storageFile;
