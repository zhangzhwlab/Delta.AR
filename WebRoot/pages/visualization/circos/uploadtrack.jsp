...
<div class="header_content" id="physical-upload">
	<form action="/deltaar/pipeline/circletAddTrack.action" method="post" enctype="multipart/form-data" onSubmit="return checkEmpty()">
	<input type="hidden" name="circosTrack.category" value="Add Track"/>
	<table width="458" cellpadding="5" cellspacing="0">
		<tbody>
				<tr><td>Dataset Name<span style="color:red;">*</span></td><td><input id="updatasetid"  type="text" name="circosTrack.dataset" value="" style="width:200px;"/>&nbsp;<img src="/deltaar/images/help.gif" title="To upload multiple data track into the same view,please fill the same dataset name"/> <span id="iddataseterr" style="color:red;"></span></td></tr>
				<tr><td width="123">Track Name<span style="color:red;">*</span></td>
				<td width="313"><input type="text" name="circosTrack.name" value="" style="width:200px;" id="idtrackname"/>&nbsp;<img src="/deltaar/images/help.gif" title="An unique name consitutes by charactersA-Za-z,numbers0-9 and _ without white spaces" /><span id="idnameerr" style="color:red;"></span></td></tr>
				...
				<tr><td>Upload File<span style="color:red;">*</span></td><td><input name="myFile" type="file" size="35" id="idmyfile"/><span><a href="/deltaar/pages/help/help_topoview.jsp#31" style="color:red;">format</a></span><span id="idfileerr" style="color:red;"></td></tr>
		</tbody>
