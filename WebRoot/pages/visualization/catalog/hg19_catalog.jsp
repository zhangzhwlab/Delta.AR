...
<div id="container">
	<div id="content" >
	  ...
	  <div id="left-column1" style="margin-left:0px;  ">
			...
			<div class="header_border" style="padding-top:10px; padding-bottom:10px; height:20px;   background: #e9e9e9 none repeat scroll 0 0;">
			...
			<div style="float:left;padding-left:5px;"><span id="idtwait" style="display:none;"><img src="/deltaar/images/wait.gif"></span></div>
			</div>
...
<!--
<script type="text/javascript" src="/deltaar/js/circlet/init.js"></script> -->
...
function refreshCatalog(){
    //get all the class equal selected, got the item categoty, item name
			...
			//var curdataset= "conf/circlet/1478854512827.conf";
			var curdataset= $("#cdset").val();
			var params={"plist":plist,"param1":curdataset};
...
function cataToggleTrack(category,track,index){
  $("#idtwait").css("display","block");
	if($("#tctlst_"+track).prop("checked") == true){
		$("#tlst_"+track).prop('checked',true);
	}else{
		$("#tlst_"+track).prop('checked',false);
	}
	 
	//window.parent.topotoggleTrack(category,track,index);
    topotoggleTrack(category,track,index);
}
