	...
	<div id="content">
	  <div id="right-column1" style="margin-left:10px;width:20%;margin-top:10px;">
			...
			<div class="header_content">
				<b>Organism:</b> Human<br/> <b>Cell line:</b> GM12878<br/><b>Bin size:</b> 50,000<br/> 
	  ...
	  <div id="left-column1" style="margin-left:5px; width:60%;">
			...
			%>
				...
				<input name="pipeBean.startPosition" value="0" type="hidden" />
				...
				<div class="header_content" style="position:relative;">
				 ...
				 &nbsp;&nbsp; &nbsp;Bin Size: the bin size of Hi-C contact matrix file. If the uploaded file has high resolution, we suggest you compute an interested region instead of the whole chromosome.<br/>
	...
	function checkUseTestData(){
		if($("#idusetest").prop("checked") == true){
			disableform("pipeform",true);
			 document.getElementById("idmatrixfile").value= "/share/backup2/deltabakcup/hic/testdata/useown/50k.matrix";
		    document.getElementById("idloopfile").value= "/share/backup2/deltabakcup/hic/testdata/useown/test_loop.gff3";
			document.getElementById("idtadfile").value= "/share/backup2/deltabakcup/hic/testdata/useown/test_tad.gff3";
			document.getElementById("idmodelfile").value= "/share/backup2/deltabakcup/hic/testdata/useown/test_model.xyz";
		}else{
