	  ...
	  <div id="left-column1" style="margin-left:5px; width:70%;">
			<div class="header_border">
				<div class="header_content">
					...
					<div class="header"><a target="_blank" href="/jbrowse/index.html?data=<s:property value='jobid'/>&loc=<s:property value='pipeBean.chrom'/>%3A<s:property value='pipeBean.chromStart'/>..<s:property value='pipeBean.chromEnd'/>&tracks=Interaction,TAD&organism=<s:property value='pipeBean.organism'/>&resolution=<s:property value='pipeBean.binsize'/>&sb=<s:property value='pipeBean.startbin'/>">Genome View</a></div>
				   <div class="header"><a target="_blank" href="/circosweb/pages/visualization/topo_viewm.jsp?conf=<s:property value='jobid'/>&loc=<s:property value='pipeBean.chrom'/>%3A<s:property value='pipeBean.chromStart'/>..<s:property value='pipeBean.chromEnd'/>&tracks=Interaction&organism=<s:property value='pipeBean.organism'/>&resolution=<s:property value='pipeBean.binsize'/>&sb=<s:property value='pipeBean.startbin'/>">Topological View</a></div>
					
					<div class="header"><a target="_blank" href="/circosweb/pages/visualization/physical_view.jsp?conf=<s:property value='jobid'/>&loc=<s:property value='pipeBean.chrom'/>%3A<s:property value='pipeBean.chromStart'/>..<s:property value='pipeBean.chromEnd'/>&tracks=3dmodel&zoom=146">Physical View</a></div>
			...
			<div class="header_content">
				<table>
					<tbody>
						...
						<s:property value="pipeBean.organism"/>
