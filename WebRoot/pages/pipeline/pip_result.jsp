	  ...
	  <div id="left-column1" style="margin-left:5px; width:70%;">
			<div class="header_border">
				<div class="header_content">
					<div class="header">JobID <s:property value="jobid"/> <span style="padding-left:100px;"><a style="color:blue;" href="javascript:bookmarksite('JOB ID_<s:property value="jobid"/>', 'http://delta.big.ac.cn/pipeline/showResult.action?jobid=<s:property value="jobid"/>&binsize=<s:property value="pipeBean.binsize"/>&organism=<s:property value="pipeBean.organism"/>&chr=<s:property value="pipeBean.chrom"/>')">Bookmark this page</a></span></div>
					...
					<div class="header">The result of calling TAD&nbsp;&nbsp;&nbsp;&nbsp;<a href="/pipeline/downloadFile.action?flag=1&amp;jobid=<s:property value='#parameters.jobid'/>">Download</a>&nbsp;&nbsp;&nbsp;&nbsp;<a target="_blank" href="/jbrowse/index.html?data=<s:property value='#parameters.jobid'/>&loc=<s:property value='pipeBean.chrom'/>%3A<s:property value='pipeBean.chromStart'/>..<s:property value='pipeBean.chromEnd'/>&tracks=matrix,TAD&organism=<s:property value='pipeBean.organism'/>&resolution=<s:property value='pipeBean.binsize'/>&sb=<s:property value='pipeBean.startbin'/>">Genome View</a></div>
					<div class="note" style="margin-bottom:10px;">Note:the first 100 lines of the result file will be shown</div>
				...
				<div class="header_content">
					<div class="header">The result of calling interaction loop&nbsp;&nbsp;&nbsp;&nbsp;<a href="/pipeline/downloadFile.action?flag=2&amp;jobid=<s:property value='#parameters.jobid'/>">Download</a>&nbsp;&nbsp;&nbsp;&nbsp;<a target="_blank" href="/circosweb/pages/visualization/topo_viewm.jsp?conf=<s:property value='#parameters.jobid'/>&loc=<s:property value='pipeBean.chrom'/>%3A<s:property value='pipeBean.chromStart'/>..<s:property value='pipeBean.chromEnd'/>&tracks=Interaction,GM12878_EZH2,GM12878_RNA-Seq_plus&organism=<s:property value='pipeBean.organism'/>&resolution=<s:property value='pipeBean.binsize'/>&sb=<s:property value='pipeBean.startbin'/>">Topological View</a></div>
					   <div class="note" style="margin-bottom:10px;">Note:the first 100 lines of the result file will be shown</div>
				...
				<div class="header_content">
					<div class="header">The result of 3D physical model&nbsp;&nbsp;&nbsp;&nbsp;<a href="/pipeline/downloadFile.action?flag=3&amp;jobid=<s:property value='#parameters.jobid'/>">Download</a>&nbsp;&nbsp;&nbsp;&nbsp;<a target="_blank" href="/circosweb/pages/visualization/physical_view.jsp?conf=<s:property value='#parameters.jobid'/>&loc=<s:property value='pipeBean.chrom'/>%3A<s:property value='pipeBean.chromStart'/>..<s:property value='pipeBean.chromEnd'/>&tracks=3dmodel,TAD,Interaction,GM12878_H2AZ&zoom=146">Physical View</a></div>
					<div class="note" style="margin-bottom:10px;">Note:the first 100 lines of the result will be shown </div> 
			...
			<div class="header_content">
				<table>
					<tbody>
						...
						<s:elseif test="pipeBean.physicalModel == 'MOGEN'">
						...
						<s:else>
						<tr><td width="394"><strong>Maximum iteration numbers(Maxiter)</strong></td>
								<td width="536">
								<s:property value="pipeBean.hsamaxiter"/>								</td></tr>
								<tr><td style="vertical-align:top;"><strong>Epslon</strong></td>
								<td><s:property value="pipeBean.hsaepslon"/></td></tr>
						</s:else>
