...
public class PipelineAction extends ActionSupport{
	...
	//	String path="D:\\";
		...
		if(pipeBean != null){
			...
			//	chromlength = ( Integer.parseInt(pipeBean.getEndbin()) - Integer.parseInt(pipeBean.getStartbin()) +1) * Integer.parseInt(pipeBean.getBinsize());
				...
				sb.append("#!/bin/sh\n");
				sb.append("export PATH=$PATH:/share/backup2/deltabakcup/hic/scripts20160514\n");
				sb.append("nohup perl /share/backup2/deltabakcup/hic/scripts20160514/module_genome.pl -c ").append(pipeBean.getChrom());
				...
				sb.append("#!/bin/sh\n");
				sb.append("export PATH=$PATH:/share/backup2/deltabakcup/hic/scripts20160514\n");
				sb.append("nohup perl /share/backup2/deltabakcup/hic/scripts20160514/module_tadtree.pl -c ").append(pipeBean.getChrom());
				...
				sb.append("nohup perl /share/backup2/deltabakcup/hic/scripts20160514/module_fasthic.pl -c ").append(pipeBean.getChrom());
				sb.append(" -pl ").append("/share/backup2/deltabakcup/hic/scripts20160514/");
				sb.append(" -b ").append(pipeBean.getBinsize());
				...
				if(pipeBean.getPhysicalModel().equals("BACH")){
					...
					sb.append("nohup perl /share/backup2/deltabakcup/hic/scripts20160514/module_bach.pl -i ");
					if(pipeBean.getUseTest() != null && pipeBean.getUseTest().equals("1")){
						sb.append(pipeBean.getMatrixFile());
						sb.append(" -vf ").append("1"); //delta preprocessed feature file
						...
						if(pipeBean.getFeatureFileType() == 1){
							sb.append(" -vf ").append("1");
						}else if(pipeBean.getFeatureFileType() == 2){
							sb.append(" -vf ").append("2");
							String featurefile = path+File.separator+jobid+File.separator+"upload"+File.separator+pipeBean.getFeatureFile();//feature file						
							sb.append(" -f ").append(featurefile);
						}
					}
					...
					sb.append("#!/bin/sh\n");
					sb.append("export PATH=$PATH:/share/backup2/deltabakcup/hic/scripts20160514\n");
					sb.append("nohup perl /share/backup2/deltabakcup/hic/scripts20160514/module_MOGEN.pl -pl /share/backup2/deltabakcup/hic/scripts20160514");
					sb.append(" -c ").append(pipeBean.getChrom());
					if(pipeBean.getUseTest() != null && pipeBean.getUseTest().equals("1")){
				...
				}else if(pipeBean.getPhysicalModel().equals("HSA") == true){
					String mogenpath = path+File.separator+jobid+File.separator+"hsa";
					file = new File(mogenpath);
					if(file.exists() == false){
							file.mkdirs();
					}
					...
					sb.append("#!/bin/sh\n");
					sb.append("export PATH=$PATH:/share/backup2/deltabakcup/hic/scripts20160514\n");
					sb.append("nohup perl /share/backup2/deltabakcup/hic/scripts20160514/module_hsa.pl -pl /share/backup2/deltabakcup/hic/scripts20160514");
					sb.append(" -c ").append(pipeBean.getChrom());
					if(pipeBean.getUseTest() != null && pipeBean.getUseTest().equals("1")){
						sb.append(" -obm ").append(pipeBean.getMatrixFile());
					}else{
					...
					sb.append(" -bin ").append(pipeBean.getBinsize());
					sb.append(" -o ").append(mogenpath);
					sb.append(" -maxtier ").append(pipeBean.getHsamaxiter());
					sb.append(" -epslon ").append(pipeBean.getHsaepslon());
					sb.append(" -spos ").append(pipeBean.getChromStart());
					//"pl=s","c=s","obm=s","bin=s","o=s","maxtier=s","epslon=s","jb=s","spos=s","sp=s","sb=s","tpath=s","bn=s",
					sb.append(" -sb ").append(pipeBean.getStartbin());
					sb.append(" -tpath ").append(webpath);
					int binnum = Integer.parseInt(pipeBean.getEndbin()) - Integer.parseInt(pipeBean.getStartbin())  + 1;
					sb.append(" -bn ").append(binnum);
					sb.append(" -jb ").append(jobid );
					sb.append(" -sp ").append(pipeBean.getOrganism());
					sb.append(" > ").append(mogenpath).append(File.separator).append("nohup.out 2>&1 &").append("\n");
					
					String mogensh = mogenpath+File.separator+"process_HSA.sh" ;
					bw = new BufferedWriter(new FileWriter(mogensh));
					bw.write(sb.toString());
					bw.close();					
					Runtime.getRuntime().exec("chmod 700 "+mogensh);	//shell path
	...
	public String execUseOwnDataFunc(){
		try{
			...
			GenerateCircletConf circonf = new GenerateCircletConf(webpath,pipeBean.getOrganism(),this.jobid,pipeBean.getBinsize(),pipeBean.getChrom(),loopfile,hicmatrixfile,pipeBean.getStartbin()); 
		...
		try{
			...
			if(this.modelstr != null ){
				...
				if(this.modelstr.equals("BACH")){
					...
					resfile = bachpath+File.separator+pipeBean.getChrom()+File.separator+pipeBean.getChrom()+".xyz" ;
				}else if(this.modelstr.equals("HSA")){
					bachpath = path+File.separator+jobid+File.separator+"hsa";
					finishfile = bachpath +File.separator+"hsa.finish";
					resfile = bachpath+File.separator+pipeBean.getChrom()+File.separator+pipeBean.getChrom()+".xyz" ;
				}
			}
		...
		try{
			...
			if(this.modelstr != null ){
				...
				if(this.modelstr.equals("BACH")){
					...
					bachpath = path+File.separator+jobid+File.separator+"hsa";
					finishfile = bachpath +File.separator+"hsa.finish";
					resfile = bachpath+File.separator+this.chrom+File.separator+"HSA."+this.chrom+".out" ;
				}
			}
