...
public class SendEmail {
	...
	public static String doSendEmail(String jobid, String email) {
	    ...
	    try{
			   ...
			   sb.append("Dear user,\n\n");
			   sb.append("A new task has been submitted to Delta with JOBID ").append(jobid).append("\n\n");
			   
			   sb.append("The result can be retrieved by URL http://delta.big.ac.cn/pipeline/showResult.action?jobid=").append(jobid).append("\n\n");
