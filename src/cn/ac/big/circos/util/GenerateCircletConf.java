...
public class GenerateCircletConf {
	...
	private String hicmatrix;
	private String sb;
	
	public GenerateCircletConf(String path, String organism,String jobid,String binsize,String chrom,String loopfile,String hicmatrix,String sb){
		this.path = path;
		this.jobid = jobid;
	...
	public int generateConf(){
		...
		try{
			...
			bw.write("conf=conf/circlet/"+jobid+".conf\n");	
     		...
     		bw.write("perl /share/backup2/deltabakcup/hic/scripts20160514/module_fasthic_owndata.pl -c "+chrom+" -pl /share/backup2/deltabakcup/hic/scripts20160514/ -b "
     		+this.binsize+" -sp "+this.organism+" -i "+hicmatrix+" -o "+targetpath+" -o1 "+targetpath+" -sb "+this.sb+" -spos 0 -tpath /share/backup2/deltabakcup/circosweb2016/circosweb/ -fval 0.95\n");
     		bw.write("sort -n -k3,4 "+targetfilepath+" > "+targetfilepath+".srt\n");
     		bw.write("/share/backup2/deltabakcup/hic/software/tabix-master/bgzip "+targetfilepath+".srt\n");
     		bw.write("/share/backup2/deltabakcup/hic/software/tabix-master/tabix -p gff -s 1 -b 4 -e 5 "+targetfilepath+".srt.gz\n");
			bw.close();
