...
public class PipeBean {
	...
	private int featureFileType; // feature type file , 1 embed feature file , 2 upload feature file
	
	
	//HSA parameters
	private String hsamaxiter;
	private String hsaepslon ;
	
	
	
	public String getHsamaxiter() {
		return hsamaxiter;
	}

	public void setHsamaxiter(String hsamaxiter) {
		this.hsamaxiter = hsamaxiter;
	}

	public String getHsaepslon() {
		return hsaepslon;
	}

	public void setHsaepslon(String hsaepslon) {
		this.hsaepslon = hsaepslon;
	}

	public int getFeatureFileType() {
		return featureFileType;
	}

	public void setFeatureFileType(int featureFileType) {
		this.featureFileType = featureFileType;
	}
